...
< class="col-md-2 sidebar" id="sidebar" style="background-color: #343a40; color: #f8f9fa; min-height: 100vh; padding: 15px;">
    <h2 style="color: #f8f9fa;">Menu</h2>
    <a href="{{ route('dashboard') }}" style="color: #f8f9fa; display: block; margin-bottom: 10px;">
       Dashboard <i class="fas fa-tachometer-alt"></i> 
    </a>
                ...
                <div class="card-footer d-flex justify-content-between">
                    ...
                    @if(Auth::user()->role === 'admin')
                        <div>
                            ...
                            <x-deletebutton :action="route('categories.destroy', $category->id)" />
                        </div>
                    @endif
                </div>
            </div>
